...
<html>
  ...
  <div class="myNav">
	...
	-moz-box-shadow:0 0 5px rgba(92,92,92,0.4);background-color:#fff;width:800px;height:30px;border:1px solid #ddd;position: relative;margin:30px auto;">
	 	...
	 	<c:forEach items="${requestScope.items }" var="item" varStatus="s">
	 		<div class="formatStringt">
	 			...
	 			<p style="margin:20px;">${item.itemdesc }</p>
