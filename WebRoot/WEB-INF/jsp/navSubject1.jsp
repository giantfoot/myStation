...
<html>
  <head>
    ...
    <title>天天动漫${requestScope.items[0].itemtab }</title>
    
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="${requestScope.items[0].itemtab }">
	<meta http-equiv="description" content="${requestScope.items[0].itemtab }">
	...
	<style type="text/css">
		...
		*{
		...
		.myTab{
			...
			background-color: #fff;
			box-shadow:0 0 10px rgba(92,92,92,0.4);
  ...
  <body style="width: 1366px;margin:0 auto;background-color:#F2F7F1">
	...
	width:30px;"/>
	 	...
	 	<div style="width:1366px;margin:0px auto;background-color:#fff;">
	 	<div style="box-shadow:0 0 2px rgba(92,92,92,0.4);
	-webkit-box-shadow:0 0 2px rgba(92,92,92,0.4);
	-moz-box-shadow:0 0 2px rgba(92,92,92,0.4);background-color:#fff;width:800px;height:30px;border:1px solid #ddd;position: relative;top:30px;margin:0px auto;">
	 		&nbsp;&nbsp;现在的位置:<a href="#">&nbsp;首页</a>&nbsp;&gt;&nbsp;${requestScope.items[0].itemtab }
	 	...
	 	<div style="width:800px;position: relative;top:40px;margin:40px auto;overflow:hidden;text-overflow:ellipsis;">
	 			...
	 			<div style="width:100%;height:110px">
					<div style="text-align:center;display:inline-block;width:120px">
						<div class="myTime">
							<fmt:formatDate value="${item.itemtime }" pattern="MM-dd HH:mm"/>
						</div>
					</div>
					...
					<div class="myTab">
						<img src="${item.itemimgurl }" class="itemPic">
						<h4 style="display:inline-block;margin-top:25px">
							<a href="${pageContext.request.contextPath }/user/contentFrame.action?itemename=${item.itemename }" class="myLink2">${item.itemname }</a>
						</h4>
					</div>
				</div>	
	 		</c:forEach>	
	...
	<!-- 多说评论框 start -->
	<div class="ds-thread" style="width:800px;border:1px solid #ddd;position:relative;top:30px;margin:30px auto;padding:10px" data-thread-key="contentFrame" data-title="contentFrame" data-url="请替换成文章的网址"></div>
	<!-- 多说评论框 end -->
