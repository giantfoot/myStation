...
<html>
  <head>
	...
	<meta http-equiv="keywords" content=" 天天动漫,资讯">
	<meta http-equiv="description" content="天天动漫,资讯">
	...
	<style type="text/css">
		...
		*{
		...
		.myTab:hover{
			...
			-moz-box-shadow:1px 1px 1px 1px rgba(100,100,100,0.3);
			-o-box-shadow:1px 1px 1px 1px rgba(100,100,100,0.3);
		...
		.smallSubject .myLink1{
			text-decoration:none;
			color:#000;
		}
		.smallSubject .myLink1:hover{
			color:#158E62;
		}
		.myLink2{
			text-decoration:none;
  ...
  <body style="width: 1366px;margin:0 auto;background-color:#F4F5F7">
 ...
 <div class="myNav">
	...
	width:30px;"/>
	 	...
	 	<div style="width:1366px;margin:0px auto;margin-top:-50px;background-color:#fff;">
	 	<div style="box-shadow:0 0 3px rgba(92,92,92,0.4);
	-webkit-box-shadow:0 0 3px rgba(92,92,92,0.4);
	-moz-box-shadow:0 0 3px rgba(92,92,92,0.4);background-color:#fff;width:800px;height:30px;border:1px solid #ddd;position: relative;top:30px;margin:30px auto;">
	 		&nbsp;&nbsp;现在的位置:<a href="#">&nbsp;首页</a>&nbsp;&gt;&nbsp;${requestScope.topSubject }
	 	...
	 	<div style="width:800px;position: relative;top:30px;margin:30px auto;overflow:hidden;text-overflow:ellipsis;">
	 			<div style="width:100%;height:110px">
					<div style="text-align:center;display:inline-block;width:120px">
						<div class="myTime">04-20&nbsp;&nbsp;12:30</div>
					</div>
					...
					<div class="myTab">
						<img src="${pageContext.request.contextPath }/images/pic1/迷家.jpg" class="itemPic">
						<h4 style="display:inline-block;margin-top:25px">
							<a href="" class="myLink2">迷家惊奇上映</a>
						</h4>
					</div>
				</div>	
	 			<div style="width:100%;height:110px">
					...
					<div class="myTab">
						<img src="${pageContext.request.contextPath }/images/pic1/从零开始的异世界生活.jpg" class="itemPic">
						<h4 style="display:inline-block;margin-top:25px">
							<a href="" class="myLink2">从零开始的异世界生活</a>
						</h4>
					</div>
				</div>	
	 			<div style="width:100%;height:110px">
					...
					<div class="myTab">
						<img src="${pageContext.request.contextPath }/images/pic1/希德尼娅的骑士.jpg" class="itemPic">
						<h4 style="display:inline-block;margin-top:25px">
							<a href="" class="myLink2">希德尼娅的骑士</a>
						</h4>
					</div>
				</div>	
	 			<div style="width:100%;height:110px">
					...
					<div class="myTab">
						<img src="${pageContext.request.contextPath }/images/pic1/铁甲城的卡巴内瑞2.jpg" class="itemPic">
						<h4 style="display:inline-block;margin-top:25px">
							<a href="" class="myLink2">甲铁城的卡巴内瑞无删减版尽在天天动漫</a>
						</h4>
					</div>
				</div>	
	 			<div style="width:100%;height:110px">
					...
					<div class="myTab">
						<img src="${pageContext.request.contextPath }/images/pic1/rwby.jpg" class="itemPic">
						<h4 style="display:inline-block;margin-top:25px">
							<a href="" class="myLink2">RWBY四人组燃情战斗</a>
						</h4>
					</div>
				</div>	
	 			<div style="width:100%;height:110px">
					...
					<div class="myTab">
						<img src="${pageContext.request.contextPath }/images/pic1/亚人4.jpg" class="itemPic">
						<h4 style="display:inline-block;margin-top:25px">
							<a href="" class="myLink2">亚人-不死的种族</a>
						</h4>
					</div>
				</div>	
	 			<div style="width:100%;height:110px">
	...
	<!-- 多说公共JS代码 end -->
	<!-- cnzz统计 -->
	 <!-- <div style="background-color:#222;width:1366px;height:40px;text-align:center;">
